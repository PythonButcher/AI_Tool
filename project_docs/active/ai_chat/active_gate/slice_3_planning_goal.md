...
Acceptance checks:
- A clear, bounded frontend handoff is written for Gemini/Antigravity to implement the interactive chart context.
...
Codex/Antigravity owns this planning step. The goal is complete when the handoff for Slice 3 is ready in `project_docs/active/ai_hand_off/` and the active docs are updated.
