...
This folder contains deferred Codex-authored audits, plans, and goal records. These files are not active implementation gates unless the current project status and active-gate README explicitly promote one.
