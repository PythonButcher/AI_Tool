...
- the UI captures the remaining high-value V1 structure needed for honest workspace resolution
...
- legacy decision-bundle outputs remain additive through the legacy path, but the DI 2.0 workspace should remain the primary frame when `decision_workspace` exists
