> Archived September 13, 2026. Historical outgoing gate only; it is not an active implementation instruction.
...
Use `project_docs/archive/document_studio/standalone_product_roadmap_retired_2026_09_13.md` for the historical sequence and `project_docs/active/rules/CODEX_FRONTEND_GUARDRAIL_READ_FIRST.md` for ownership boundaries.
